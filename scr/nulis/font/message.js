...
async function LoadDataBase(naze, m) {
	try {
		...
		const defaultSetBot = {
			...
			multiprefix: false,
			privateonly: true,
			author: global.author || 'Suman',
			autobackup: false,
			botname: global.botname || 'Lebu Bot',
...
async function MessagesUpsert(suman, message, store) {
	try {
...
async function Solving(suman, store) {
